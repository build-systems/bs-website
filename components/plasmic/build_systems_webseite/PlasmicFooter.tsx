...
import sty from "./PlasmicFooter.module.css"; // plasmic-import: XG5TargEes9F/css

import LinkedinSvgrepoComsvgIcon from "./icons/PlasmicIcon__LinkedinSvgrepoComsvg"; // plasmic-import: nK-kaDfMwSWB/icon
...
function PlasmicFooter__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__iyUU)}>
        <div className={classNames(projectcss.all, sty.freeBox__p2A4V)}>
          <div
            className={classNames(
              projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__p57M)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__ocdRf)}
              onClick={async event => {
                const $steps = {};
